...
| Admin/crawl UI | `public/routes/admin.mjs`, `public/routes/adminSeriesView.mjs`, `public/routes/adminProductionView.mjs`, `server/index.mjs`, `server/crawlJobStore.mjs` |
