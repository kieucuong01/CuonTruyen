...
import { buildAdminProductionStatus } from './adminProductionStatus.mjs';
...
async function readAdminProductionStatus() {
  ...
  try {
    ...
    const value = buildAdminProductionStatus(catalog, syncState, syncStatus, catalogStorageSummary());
